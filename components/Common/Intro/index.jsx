...
import Tanjin from '../../../public/images/tanjin.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' src={Tanjin} alt='profile picture' />
      ...
      {/* middle components */}
      <div className='beech z-20 flex flex-col overflow-y-scroll pt-48 top-48 space-y-6 divide-y divide-[#ff00e6] overflow-x-hidden no-scrollbar px-4'>
        <Location />
        <Skills />
        <Languages />
        <Tools />
